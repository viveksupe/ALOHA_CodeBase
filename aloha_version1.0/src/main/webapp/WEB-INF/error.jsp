...
<head>
    ...
    * { padding:0; margin:0; }
    ...
    body {
        ...
        font-size:12px;
        color:#333;
        background: #F5D1E3 url(https://bitly.com/static/graphics/sky-404.png) repeat-x 0 0;
        color: #FFF;
        overflow-x:hidden;
        position: relative;
    }
    ...
    #cloud1 {
        ...
        height: 88px;
        left: 50px;
        background: transparent url(https://bitly.com/static/graphics/cloud1-404.png) no-repeat scroll 0 0;
    }
    #cloud2 {
        position: absolute;
        top: 220px;
        ...
        height: 29px;
        left: 275px;
        background: transparent url(https://bitly.com/static/graphics/cloud2-404.png) no-repeat scroll 0 0;
    }
    #gull {
        position: absolute;
        top: 150px;
...
// chartbeat
var _sf_async_config={uid: 30, sections: 'error', pingServer: 'pdev.chartbeat.net', domain: 'bit.ly' };
(function(){
...
c,C,B=!1,P=Math.PI/180,f,z,h,k,s=[Math.floor(0.75*d),0],n=[236,195],w,l,L,J,M,K=[75,150],E=[{h:58,w:140,t:0,l:0,mt:10},{h:72,w:150,t:-64,l:0,mt:0},{h:61,w:150,t:-151,l:0,mt:30}],N=!1;g=document.createElement("canvas");g.getContext&&(N=!0,document.body.removeChild(document.getElementById("ripple")),g.setAttribute("id","ripple"),document.body.appendChild(g),k=document.getElementById("fish"),l=document.getElementById("gull"),l.setAttribute("src","https://bitly.com/static/graphics/gulls-404.png"));N&&(function(){try{if(fish.complete)m();
